...
setup(
    name='sopel_modules.ermahgerd',
    version='0.1.0',
    description='Sopel plugin to generate "ermahgerd" text (based on the ermahgerd meme)',
    long_description=readme + '\n\n' + history,
    author='Sam Zick',
    author_email='sam@deathbybandaid.net',
    url='https://github.com/deathbybandaid/sopel-ermahgerd',
